...
<%@page import="com.model.CustomersModel"%>
...
/* 		List<Books> myBookList = null; */
	...
	<c:forEach var="it" items="${sessionScope.cart}">
		...
		<c:set var="SubTotal" value="${it.books.price * it.quantity }" scope="session"></c:set>
		...
		<%
			...
			CustomerDetailsModel.saveCustomerDetails(customerDetails);
		%>
	</c:forEach>
	<div class="container">
		<div class="row">
			...
			<h3>
				Hi
				<%=userName%>!! Your Order has been confirmed. The Books shall be delivered within 2 Days
			</h3>
			</p>
